...
const testIfUsingNativeCSSVariables = (test) => (window.ShadyCSS && !window.ShadyCSS.nativeCss ? test.skip : test);
suite('shady-render @apply', () => {
    ...
    testIfUsingNativeCSSVariables(test)('@apply styles flow to custom elements that render in connectedCallback', () => {
...
//# sourceMappingURL=shady-render-apply_test.js.map