...
suite('Template', function () {
    ...
    test('content', function () {
        ...
        assert.equal(template.content.childNodes.length, 1, 'template content has expected number of nodes');
        assert.isNull(document.querySelector('#content'), 'template content not in document');
    });
...
//# sourceMappingURL=template_polyfill_test.js.map